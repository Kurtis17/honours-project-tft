...
class UI_Board_Widget(QWidget):
    ...
    def setup_ui_board_widget(self, Board_Widget, main_window):
        ...
        self.enemy_unit_1_1.clicked.connect(lambda: self.unit_clicked(Board_Widget, "1,1"))
        self.enemy_unit_1_2.clicked.connect(lambda: self.unit_clicked(Board_Widget, "1,2"))
        self.enemy_unit_1_3.clicked.connect(lambda: self.unit_clicked(Board_Widget, "1,3"))
        self.enemy_unit_1_4.clicked.connect(lambda: self.unit_clicked(Board_Widget, "1,4"))
        self.enemy_unit_1_5.clicked.connect(lambda: self.unit_clicked(Board_Widget, "1,5"))
        self.enemy_unit_1_6.clicked.connect(lambda: self.unit_clicked(Board_Widget, "1,6"))
        self.enemy_unit_1_7.clicked.connect(lambda: self.unit_clicked(Board_Widget, "1,7"))

        self.enemy_unit_2_1.clicked.connect(lambda: self.unit_clicked(Board_Widget, "2,1"))
        self.enemy_unit_2_2.clicked.connect(lambda: self.unit_clicked(Board_Widget, "2,2"))
        self.enemy_unit_2_3.clicked.connect(lambda: self.unit_clicked(Board_Widget, "2,3"))
        self.enemy_unit_2_4.clicked.connect(lambda: self.unit_clicked(Board_Widget, "2,4"))
        self.enemy_unit_2_5.clicked.connect(lambda: self.unit_clicked(Board_Widget, "2,5"))
        self.enemy_unit_2_6.clicked.connect(lambda: self.unit_clicked(Board_Widget, "2,6"))
        self.enemy_unit_2_7.clicked.connect(lambda: self.unit_clicked(Board_Widget, "2,7"))

        self.enemy_unit_3_1.clicked.connect(lambda: self.unit_clicked(Board_Widget, "3,1"))
        self.enemy_unit_3_2.clicked.connect(lambda: self.unit_clicked(Board_Widget, "3,2"))
        self.enemy_unit_3_3.clicked.connect(lambda: self.unit_clicked(Board_Widget, "3,3"))
        self.enemy_unit_3_4.clicked.connect(lambda: self.unit_clicked(Board_Widget, "3,4"))
        self.enemy_unit_3_5.clicked.connect(lambda: self.unit_clicked(Board_Widget, "3,5"))
        self.enemy_unit_3_6.clicked.connect(lambda: self.unit_clicked(Board_Widget, "3,6"))
        self.enemy_unit_3_7.clicked.connect(lambda: self.unit_clicked(Board_Widget, "3,7"))

        self.enemy_unit_4_1.clicked.connect(lambda: self.unit_clicked(Board_Widget, "4,1"))
        self.enemy_unit_4_2.clicked.connect(lambda: self.unit_clicked(Board_Widget, "4,2"))
        self.enemy_unit_4_3.clicked.connect(lambda: self.unit_clicked(Board_Widget, "4,3"))
        self.enemy_unit_4_4.clicked.connect(lambda: self.unit_clicked(Board_Widget, "4,4"))
        self.enemy_unit_4_5.clicked.connect(lambda: self.unit_clicked(Board_Widget, "4,5"))
        self.enemy_unit_4_6.clicked.connect(lambda: self.unit_clicked(Board_Widget, "4,6"))
        self.enemy_unit_4_7.clicked.connect(lambda: self.unit_clicked(Board_Widget, "4,7"))

        self.user_unit_1_1.clicked.connect(lambda: self.unit_clicked(Board_Widget, "5,1"))
        self.user_unit_1_2.clicked.connect(lambda: self.unit_clicked(Board_Widget, "5,2"))
        self.user_unit_1_3.clicked.connect(lambda: self.unit_clicked(Board_Widget, "5,3"))
        self.user_unit_1_4.clicked.connect(lambda: self.unit_clicked(Board_Widget, "5,4"))
        self.user_unit_1_5.clicked.connect(lambda: self.unit_clicked(Board_Widget, "5,5"))
        self.user_unit_1_6.clicked.connect(lambda: self.unit_clicked(Board_Widget, "5,6"))
        self.user_unit_1_7.clicked.connect(lambda: self.unit_clicked(Board_Widget, "5,7"))

        self.user_unit_2_1.clicked.connect(lambda: self.unit_clicked(Board_Widget, "6,1"))
        self.user_unit_2_2.clicked.connect(lambda: self.unit_clicked(Board_Widget, "6,2"))
        self.user_unit_2_3.clicked.connect(lambda: self.unit_clicked(Board_Widget, "6,3"))
        self.user_unit_2_4.clicked.connect(lambda: self.unit_clicked(Board_Widget, "6,4"))
        self.user_unit_2_5.clicked.connect(lambda: self.unit_clicked(Board_Widget, "6,5"))
        self.user_unit_2_6.clicked.connect(lambda: self.unit_clicked(Board_Widget, "6,6"))
        self.user_unit_2_7.clicked.connect(lambda: self.unit_clicked(Board_Widget, "6,7"))

        self.user_unit_3_1.clicked.connect(lambda: self.unit_clicked(Board_Widget, "7,1"))
        self.user_unit_3_2.clicked.connect(lambda: self.unit_clicked(Board_Widget, "7,2"))
        self.user_unit_3_3.clicked.connect(lambda: self.unit_clicked(Board_Widget, "7,3"))
        self.user_unit_3_4.clicked.connect(lambda: self.unit_clicked(Board_Widget, "7,4"))
        self.user_unit_3_5.clicked.connect(lambda: self.unit_clicked(Board_Widget, "7,5"))
        self.user_unit_3_6.clicked.connect(lambda: self.unit_clicked(Board_Widget, "7,6"))
        self.user_unit_3_7.clicked.connect(lambda: self.unit_clicked(Board_Widget, "7,7"))

        self.user_unit_4_1.clicked.connect(lambda: self.unit_clicked(Board_Widget, "8,1"))
        self.user_unit_4_2.clicked.connect(lambda: self.unit_clicked(Board_Widget, "8,2"))
        self.user_unit_4_3.clicked.connect(lambda: self.unit_clicked(Board_Widget, "8,3"))
        self.user_unit_4_4.clicked.connect(lambda: self.unit_clicked(Board_Widget, "8,4"))
        self.user_unit_4_5.clicked.connect(lambda: self.unit_clicked(Board_Widget, "8,5"))
        self.user_unit_4_6.clicked.connect(lambda: self.unit_clicked(Board_Widget, "8,6"))
        self.user_unit_4_7.clicked.connect(lambda: self.unit_clicked(Board_Widget, "8,7"))
