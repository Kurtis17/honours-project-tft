...
class UI_Predict_Window(object):
    def open_champion_window(self, current_window):
        self.window = QtWidgets.QMainWindow()
        self.ui = UI_Champion_Selector_Window()
        self.ui.setup_ui_champion_selector_window(self.window, current_window)
        self.window.show()
        ##current_window.hide()
    ...
    def setup_ui_predict_window(self, predict_window, main_window):
        ...
        self.enemy_unit_3_1.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.enemy_unit_3_2.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.enemy_unit_3_3.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.enemy_unit_3_4.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.enemy_unit_3_5.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.enemy_unit_3_6.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.enemy_unit_3_7.clicked.connect(lambda: self.unit_clicked(predict_window))

        self.enemy_unit_4_1.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.enemy_unit_4_2.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.enemy_unit_4_3.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.enemy_unit_4_4.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.enemy_unit_4_5.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.enemy_unit_4_6.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.enemy_unit_4_7.clicked.connect(lambda: self.unit_clicked(predict_window))

        self.user_unit_1_1.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_1_2.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_1_3.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_1_4.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_1_5.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_1_6.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_1_7.clicked.connect(lambda: self.unit_clicked(predict_window))

        self.user_unit_2_1.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_2_2.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_2_3.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_2_4.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_2_5.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_2_6.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_2_7.clicked.connect(lambda: self.unit_clicked(predict_window))

        self.user_unit_3_1.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_3_2.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_3_3.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_3_4.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_3_5.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_3_6.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_3_7.clicked.connect(lambda: self.unit_clicked(predict_window))

        self.user_unit_4_1.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_4_2.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_4_3.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_4_4.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_4_5.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_4_6.clicked.connect(lambda: self.unit_clicked(predict_window))
        self.user_unit_4_7.clicked.connect(lambda: self.unit_clicked(predict_window))
